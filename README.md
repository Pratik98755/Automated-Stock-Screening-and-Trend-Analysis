...
A Python-based toolkit designed for automated financial data retrieval, symbol management, and trend analysis for stock market data.      🚀 Features 
...
Batch Automation (run_all.bat): Convenient Windows batch script to orchestrate and execute the full analysis pipeline seamlessly.  

📁 Project Structure
├── finder.py         # Symbol and asset discovery module
